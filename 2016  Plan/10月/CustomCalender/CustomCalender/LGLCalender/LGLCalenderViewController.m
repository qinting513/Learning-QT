...
@property (nonatomic,strong)     LGLCalenderCell * preCell;
...
//    self.preCell.backgroundColor = [UIColor whiteColor];
//    LGLCalenderCell *currentCell = (LGLCalenderCell*)[collectionView cellForItemAtIndexPath:indexPath];
//    currentCell.backgroundColor = LGLColor(65, 207, 79);
//    self.preCell = currentCell;
}
