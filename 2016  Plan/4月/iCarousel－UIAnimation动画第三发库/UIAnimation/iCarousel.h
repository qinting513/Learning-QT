...
#ifdef __i386__
{
    id<iCarouselDelegate> delegate;                   //iCarousel的代理成员
    id<iCarouselDataSource> dataSource;              //iCarousel的数据代理成员
    iCarouselType type;                             //iCarousel展示类型
    CGFloat perspective;                           //
...
@property (nonatomic, assign) iCarouselType type;     //展示类型
