...
/** 
 * 基本步骤：
 * 1. CABasicAnimation *anima = [CABasicAnimation animationWithKeyPath:keyPath];
 * 2. anima.fromValue = [NSNumber numberWithFloat:1.0f];
 * 2. anima.toValue = [NSNumber numberWithFloat:0.2f];
 * 3. anima.duration = 1.0f;
 * 4.  [_demoView.layer addAnimation:anima forKey:key];
 *
 */
