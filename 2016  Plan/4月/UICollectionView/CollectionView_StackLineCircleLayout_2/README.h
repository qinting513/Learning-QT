...
####使用方法
         ...
         `#import "StackLayout.h"` -- 对应的是上图的顶部 <br />  `#import "LineLayout.h"` -- 对应的是上图的中间<br />   `#import "CircleLayout.h"` -- 对应的是上图的下方<br /><br />
         3.在ViewDidLoad方法中创建布局<br />
         `  CircleLayout *layout = [[  CircleLayout alloc] init];`<br />
