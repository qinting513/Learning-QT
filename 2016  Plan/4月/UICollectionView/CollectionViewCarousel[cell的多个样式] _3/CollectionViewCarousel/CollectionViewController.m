...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:NSStringFromClass([CarouselViewCell class]) bundle:nil] forCellWithReuseIdentifier:reuseIdentifier];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"%ld.jpg", indexPath.row % 3]];
    NSLog(@"%p",image);
